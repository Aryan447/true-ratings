                ...
                <div key={season} className="bg-gray-900 p-4 rounded-lg">
                  ...
                  <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-8 gap-2">
                    {episodes.map((ep, i) => {
                      ...
                      const isSeasonBest = best && ep.imdbID === best.ep.imdbID;
                      const isSeasonWorst = worst && ep.imdbID === worst.ep.imdbID;
                      const isGlobalBest = globalBest && ep.imdbID === globalBest.ep.imdbID;
                      const isGlobalWorst = globalWorst && ep.imdbID === globalWorst.ep.imdbID;
                      return (
                        <div
                          key={i}
